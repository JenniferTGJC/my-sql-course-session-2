...
SELECT 
    ...
    ,ps.Ward
    ,ps.Hospital
    ,DATEDIFF(DAY, ps.AdmittedDate, ps.DischargeDate) AS LengthOfStay --alias for column name - used to add a column name--
FROM
    PatientStay ps
WHERE ps.Hospital IN ('Oxleas', 'Pruh')
    AND ps.AdmittedDate BETWEEN '2024-02-02' AND '2024-02-29'
...
*/
-- Write the SQL statement here
 SELECT --columns are held in this space--
    ps.Hospital
...
raw.githubusercontent.com/MarkWilcock/sql-course/refs/heads/main/Foundation Recap Exercise.sql
